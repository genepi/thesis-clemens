 ...
 * Created 21.04.2016
 */
public class NaiveVariantCallerPositionWritable implements Writable {
    private int base_A;
    private int base_C;
    private int base_G;
    private int base_T;

    public NaiveVariantCallerPositionWritable() {
        this.base_A = 0;
        this.base_C = 0;
        this.base_G = 0;
        this.base_T = 0;
    ...
    public NaiveVariantCallerPositionWritable(int base_A, int base_C, int base_G, int base_T) {
        this.base_A = base_A;
        this.base_C = base_C;
        this.base_G = base_G;
        this.base_T = base_T;
