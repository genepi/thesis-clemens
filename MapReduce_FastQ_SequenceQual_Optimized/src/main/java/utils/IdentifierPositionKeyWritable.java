...
public class IdentifierPositionKeyWritable implements WritableComparable<IdentifierPositionKeyWritable> {
    ...
    public IdentifierPositionKeyWritable() {

    }

    public IdentifierPositionKeyWritable(String sampleIdentifier, int position) {
    ...
    public boolean equals(Object o) {
        ...
        IdentifierPositionKeyWritable that = (IdentifierPositionKeyWritable) o;
    ...
    public int compareTo(IdentifierPositionKeyWritable that) {
    ...
    public static class NaiveVariantCallerKeyWritableComparator extends WritableComparator {
        public NaiveVariantCallerKeyWritableComparator() {
            super(IdentifierPositionKeyWritable.class);
        }
    ...
    static { // register this comparator
        WritableComparator.define(IdentifierPositionKeyWritable.class,
